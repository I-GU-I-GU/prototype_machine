...
const int tube_detect_pin4 = 15;
const int tube_detect_pin5 = 1;
...
void setup() {
  ...
  pinMode(tube_detect_pin4,INPUT);
  pinMode(tube_detect_pin5,INPUT);
}

void loop()
{
  // ========= get input sensors ===========
  tube_drop_logic = digitalRead(tube_detect_pin1) && digitalRead(tube_detect_pin2) && digitalRead(tube_detect_pin3) && digitalRead(tube_detect_pin4) && digitalRead(tube_detect_pin5);
