...
silo1_motor = rp2.StateMachine(0, run_silo1_motor, freq=12000, set_base=Pin(6))      # GPIO16 => pulse, GPIO17 => direction
silo2_motor = rp2.StateMachine(1, run_silo2_motor, freq=12000, set_base=Pin(12))      # GPIO18 => pulse, GPIO19 => direction
silo3_motor = rp2.StateMachine(2, run_silo3_motor, freq=12000, set_base=Pin(14))####      # GPIO18 => pulse, GPIO21 => direction
silo4_motor = rp2.StateMachine(3, run_silo4_motor, freq=12000, set_base=Pin(18))###      # GPIO18 => pulse, GPIO27 => direction
silo5_motor = rp2.StateMachine(4, run_silo5_motor, freq=12000, set_base=Pin(21))
silo6_motor = rp2.StateMachine(5, run_silo4_motor, freq=12000, set_base=Pin(27))
#========== sub functions ==========
